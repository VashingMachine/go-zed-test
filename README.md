...
[
  {
    "label": "go-discover",
    "command": "go run github.com/VashingMachine/go-zed-test/cmd/go-zed-tasks@${VERSION} -file ${ZED_FILE} -go-test-arg='-v' -go-test-arg='-count=1'",
  ...
  },
  {
    ...
    "command": "go run github.com/VashingMachine/go-zed-test/cmd/go-zed-tasks@${VERSION} debug -file ${ZED_FILE} -go-test-arg='-v' -go-test-arg='-count=1'",
    "reveal": "always",
    "reveal_target": "dock",
    "hide": "never",
    "shell": "system"
